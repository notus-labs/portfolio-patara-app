...
export const OverviewHeader = () => {
  return (
    <section className="flex w-full flex-col gap-3 rounded-b-2xl bg-custom-gray-50 p-5">
      <div className="flex flex-col gap-1 text-custom-black">
        <h3 className="text-base font-medium">Net Worth</h3>
        <h1 className="text-2.5xl font-semibold">$1,238.79</h1>
      </div>
...
export const OverviewBadges = () => {
  return (
    <section className="sticky top-[72px] z-10 flex flex-row gap-3 bg-custom-gray-200 pb-3 pt-5 lg:top-24">
